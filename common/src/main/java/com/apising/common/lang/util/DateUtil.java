...
public class DateUtil {
    ...
    public final static String Format_18 = "yyMMdd";
    ...
    public static boolean isLesserAndEqualsDay(Date day1, Date day2) throws Exception {
        if (null == day1 || null == day2) {
            throw new Exception(
                    "[DateUtil.isLargeDay]: day1 is null  or  day2 is null, day1=" + day1 + " ,  day2=" + day2);
        }
    ...
    /**
     * 获取date所在天的指定时间，比如 day为2012-12-12 12:12:12 ，assignTime是08:08:08
     * 则返回的结果是2012-12-12 08:08:08
     *
     * @return
     * @throws Exception
     */
    ...
    /**
     * 获取date所在天的timeForDate对应的时间，比如 date为2012-12-12 12:12:12
     * ，timeForDate为13:13:13 ，则返回的结果是2012-12-12 13:13:13
     *
     * @return
     * @throws Exception
     */
    ...
    public static String getSlangTime(Date curTime, Date targetTime, boolean todayIsEmpty) throws Exception {
        ...
        if (getMiddleTimeForDay(curTime).getTime() <= getMiddleTimeForDay(targetTime).getTime()) {
            ...
            if (0 == days) {
                ...
                return dayStr + dateToString(targetTime, DateUtil.Format_14);
            } else if (1 == days) {
                dayStr = "明天";
            } else {
                dayStr = dateToString(targetTime, DateUtil.Format_15);
            }
        } else {
    ...
    public static String getSlangTime2(Date curTime, Date targetTime, boolean todayIsEmpty) throws Exception {
        ...
        if (getMiddleTimeForDay(curTime).getTime() <= getMiddleTimeForDay(targetTime).getTime()) {
            ...
            if (0 == days) {
                ...
                dayStr = dateToString(targetTime, DateUtil.Format_2);
            }
        } else {
            int days = daysBetween(targetTime, curTime);
            if (1 == days) {
